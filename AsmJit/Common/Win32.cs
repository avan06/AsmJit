...
namespace AsmJit.Common
{
    internal class Win32
    {
        ...
        {
            private VirtualAllocRegion() : base(IntPtr.Zero, true) { }

            public override bool IsInvalid => handle == IntPtr.Zero;

            protected override bool ReleaseHandle() => NativeMethods.VirtualFree(handle, (UIntPtr)0, VirtualFreeType.Release);
        }
