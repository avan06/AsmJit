...
namespace AsmJit.Common.Extensions
{
    ...
    {
        public static VariableInfo GetVariableInfo(this VariableType type) => _variableInfos[type];

        public static RegisterClass GetRegisterClass(this VariableType type) => _variableInfos[type].RegisterClass;

        public static VariableType GetMappedType(this VariableType type) => Constants.X64 ? _variableTypeMappingX64[type] : _variableTypeMappingX86[type];

        public static bool IsInvalid(this VariableType type) => type == VariableType.Invalid;

        public static bool IsInt(this VariableType type) => type >= VariableType.Int8 && type <= VariableType.UIntPtr;

        public static bool IsFp(this VariableType type) => type >= VariableType.Fp32 && type <= VariableType.Fp64;

        public static bool IsMm(this VariableType type) => type == VariableType.Mm;

        public static bool IsXmm(this VariableType type) => type >= VariableType.Xmm && type <= VariableType.XmmPd;

        public static bool IsYmm(this VariableType type) => type >= VariableType.Ymm && type <= VariableType.YmmPd;

        public static bool IsZmm(this VariableType type) => type >= VariableType.Zmm && type <= VariableType.ZmmPd;

        public static bool AssertValidity(this VariableType type) => type >= VariableType.Invalid && type <= VariableType.ZmmPd;

        public static VariableType ToXmm(this VariableType type) => type == VariableType.Fp32 ? VariableType.XmmSs : (type == VariableType.Fp64 ? VariableType.XmmSd : type);
