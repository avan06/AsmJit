...
namespace AsmJit.Common.Operands
{
    ...
    {
        internal GpVariable(GpVariableType type) : base((VariableType)type) { }

        internal GpVariable(GpVariableType type, int id) : base((VariableType) type)
        {
            Id = id;
        ...
        internal GpVariable(GpVariable other) : base(other) { }

        private GpVariable(GpVariable other, GpRegisterType registerType, int size) : base(other)
        {
