...
namespace AsmJit.Common.Operands
{
    public class Immediate : Operand
    {
        ...
        internal Immediate() :base(OperandType.Immediate) { }

        internal Immediate(Immediate other) : base(other) => _data = other._data;

        private Immediate(int value) : base(OperandType.Immediate, value.GetSize()) => Int32 = value;

        private Immediate(uint value) : base(OperandType.Immediate, value.GetSize()) => UInt32 = value;

        private Immediate(long value) : base(OperandType.Immediate, value.GetSize()) => Int64 = value;

        private Immediate(ulong value) : base(OperandType.Immediate, value.GetSize()) => UInt64 = value;

        public static implicit operator Immediate(int value) => new Immediate(value);

        public static implicit operator Immediate(uint value) => new Immediate(value);

        public static implicit operator Immediate(long value) => new Immediate(value);

        public static implicit operator Immediate(ulong value) => new Immediate(value);
