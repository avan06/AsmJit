...
namespace AsmJit.CompilerContext.CodeTree
{
    internal sealed class FunctionDeclaration
    {
        ...
        public readonly RegisterMask Preserved;

        public readonly RegisterMask Passed;

        public readonly RegisterMask Used;
        ...
        internal int ArgumentCount => _arguments.Length;
