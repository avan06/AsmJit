...
namespace AsmJit.CompilerContext
{
    internal class RegisterMask
    {
        ...
        public bool IsEmpty { get => _gp == 0 && _mm == 0 && _k == 0 && _xyz == 0; }
        ...
        public void Zero(RegisterClass rc)
        {
            switch (rc)
            {
                ...
                case RegisterClass.Xyz:
                    ...
                    break;
                default:
                    throw new InvalidEnumArgumentException(string.Format("unknown RegisterClass:{0}", rc));
            }
        }
        ...
        public override string ToString() => string.Format("Gp={0}, Mm={1}, K={2}, Xyz={3}", _gp, _mm, _k, _xyz);
    }
}
